...
internal fun LLMParams.toProxyAIParams(): ProxyAIParams {
    if (this is ProxyAIParams) return this
    return ProxyAIParams(
...
/**
 * ProxyAI chat-completions parameters layered on top of [LLMParams].
 */
public open class ProxyAIParams(
